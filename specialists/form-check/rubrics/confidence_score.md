...
| 4 | Bug-class coverage | 12 | CWE Top-25 + applicable OWASP Top 10 (LLM/API/Web) + AI-PR shapes + **LLM-specific bug classes for LLM-generated code** (`checklists/bug_class_audit.md` § B) | covered the obvious 3–4 | did not consider |
